...
- The dataset is built by **`data-raw/build_corpus.R`** using `pdftools`.  
...
- **Planned URL:** <https://etc5523-2025.github.io/assignment-4-packages-and-shiny-apps-Vicky-FengZ/>
